...
public class SwaggerConfig {
    ...
    private static final String CONTACT_NAME = "Sarah Tumenas";
    private static final String CONTACT_GITHUB = "https://gtihub.com/SarahTumenas";
    private static final String CONTACT_EMAIL = "sarahtumenas@yahoo.com.br";
